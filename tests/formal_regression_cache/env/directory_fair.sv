...
module directory_fair (
    ...
    // Both clients continuously request independent lines.  Responses and
    // snoops are always consumable, so any starvation witness is due to the
    // directory arbiter rather than a blocked environment.
    localparam logic f_req_valid_0 = 1'b1;
    localparam logic f_req_valid_1 = 1'b1;
    localparam logic f_rsp_ready_0 = 1'b1;
    localparam logic f_rsp_ready_1 = 1'b1;
    localparam logic f_snp_ready_0 = 1'b1;
    localparam logic f_snp_ready_1 = 1'b1;
    ...
    always_comb begin
        ...
        i_cache_rsp_READY[0] = f_rsp_ready_0;
        i_cache_rsp_READY[1] = f_rsp_ready_1;
        i_cache_snp_READY[0] = f_snp_ready_0;
        i_cache_snp_READY[1] = f_snp_ready_1;
